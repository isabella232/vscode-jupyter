...
const autoGeneratedKernelNamePrefix = 'jupyterVSCode74a57bd0';
/**
 ...
 */
export function generateKernelNameForInterpreter(interpreter: PythonEnvironment): string {
    // Never change this logic, this is used in other places to determine the format of names we have generated.
    return `${autoGeneratedKernelNamePrefix}${getInterpreterHash(interpreter)}`;
}

export function isKernelNameGeneratedByUs(kernelSpec: IJupyterKernelSpec) {
    ...
    return kernelSpec.name.toLowerCase().indexOf(autoGeneratedKernelNamePrefix.toLowerCase());
}
/**
...
export class KernelService {
    ...
    public async searchAndRegisterKernel(
        ...
        // Otherwise register the interpreter as a new kernel
    ...
    public async registerKernel(
        ...
        // This is a predictable name (other parts of the code use the name to check if it was generated by us & matches a specific interpreter)
        const name = generateKernelNameForInterpreter(interpreter);
